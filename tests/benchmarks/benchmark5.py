...
resm, comm = ResultsMinimap2.create(ref, reads, threads = 256, ssecondary_alignments = 0, min_ratio=1, filter=1e-7)
...
# data.append(
#     [comm, resw.get_time(), evalutorw.correct, evalutorw.wrong, evalutorw.unmapped]
# )
# print(data[-1])
