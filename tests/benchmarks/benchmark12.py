...
evalutor.draw_coverage(113566686, "/home/mjkocijan/images/chromosome13_real_hifi.png", ylim = 800)
...
evalutor.draw_coverage(113566686, "/home/mjkocijan/images/chromosome13_real_minimap.png", ylim = 800)
data.append([comm, res.get_time(), evalutor.unmapped])


res, comm = ResultsWinnowmap.create(ref, reads, threads = 256, min_ratio = 1)
evalutor = RealEvaluator(str(res), str(reads), filter_mappings = True)
evalutor.draw_coverage(113566686, "/home/mjkocijan/images/chromosome13_real_winnowmap.png", ylim = 800)
data.append([comm, res.get_time(), evalutor.unmapped])
